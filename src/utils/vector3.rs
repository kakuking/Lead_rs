...
{    
    ...
    pub fn init_copy(other: &Vector3<T>) -> Self {
        if other.has_nan() {
...
impl_operator_3!(Vector3<T>, Add, add, +);
impl_operator_3!(Vector3<T>, Sub, sub, -);
impl_operator_3!(Vector3<T>, Mul, mul, *);
impl_operator_3!(Vector3<T>, Div, div, /);
